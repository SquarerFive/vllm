...
if(DEEPGEMM_SRC_DIR)
  ...
  if(DEFINED DEEPGEMM_GIT_REPO)
    set(_DEEPGEMM_UPSTREAM_REPO "${DEEPGEMM_GIT_REPO}")
  elseif(DEFINED ENV{DEEPGEMM_GIT_REPO})
    set(_DEEPGEMM_UPSTREAM_REPO "$ENV{DEEPGEMM_GIT_REPO}")
  endif()
  if(DEFINED DEEPGEMM_GIT_REF)
    set(_DEEPGEMM_UPSTREAM_TAG "${DEEPGEMM_GIT_REF}")
  elseif(DEFINED ENV{DEEPGEMM_GIT_REF})
    set(_DEEPGEMM_UPSTREAM_TAG "$ENV{DEEPGEMM_GIT_REF}")
  endif()
